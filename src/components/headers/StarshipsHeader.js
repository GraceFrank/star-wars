...
import { search_starship } from '../../redux/actions';
...
class Header extends Component {
  ...
  handleChange(e) {
    ...
    this.props.search_starship(e.target.value);
  }
  ...
  handleSearch(e) {
    if (e.key === 'Enter') {
      ...
      this.props.search_starship(searchData);
    }
  }
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Container fluid className='starships-header text-light'>
          <Row className='mb-5'>
            <Col className='mt-5'>
              <Image
                width={121}
...
Header.propTypes = {
  search_starship: PropTypes.func.isRequired,
}
const mapStateToProps = state => ({

});
export default connect(mapStateToProps, { search_starship })(Header);